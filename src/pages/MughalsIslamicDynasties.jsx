import './MughalsIslamicDynasties.css';

const content = [
  { type: 'heading', text: 'COINS OF MUGHALS AND OTHER ISLAMIC DYNASTIES' },
  ...
  { type: 'heading', text: 'Coins of Slave Dynasty of Delhi' },
  ...
  { type: 'heading', text: 'Coins of Khilji' },
  ...
  { type: 'heading', text: 'AKBAR (1556-1605 AD)' },
  ...
  },
  {
    ...
    lines: [
      ...
      'Reference: BMC#50; KM#107.1; IMC#142; Carter 7; Wright 70 Hull 1204',
      'Choice Very Fine, two contemporary loops attached',
      'Exceedingly Rare',
    ],
  },
  ...
  { type: 'heading', text: 'JAHANGIR (1605-1627 AD)' },
  ...
  },
  {
    ...
    lines: [
      ...
      'Reference: BMC#317; R.B. Whitehead, numismatic chronicle 1929, type VI, pp 21, plate 1, no 7; KM#172.1; IMC#153',
      'Choice specimen of highest rarity',
  ...
  },
  {
    ...
    lines: [
      ...
      'Reference: BMC#318, plate IX (the same dies); R.B. Whitehead, numismatic chronicle 1929, type VII, pp 22-23, plate 1, no 8; KM#179.5',
      'Choice Extremely Fine-Uncirculated. One of the finest specimen',
      'Extremely Rare',
    ],
  },
...

  {
    type: 'text',
    paragraphs: [
      `The gigantic Mughal coins are of special importance in Indian as well as world numismatics. One thousand tola gold mohur of 12 Kgs minted by Jahangir in 1613 AD, shown above realistically display the wealth that was accumulated by this dynasty. Most of these gold muhars/mohurs had poetic couplets in Persian and were the finest samples of craftmanship and metallurgy.`,
  ...
  },
  {
    ...
    lines: [
      '1605-1627 AD',
      'Silver Rupee',
      'Minted at Elichpur or Achalpur in modern Vidarbha (Maharashtra)',
      'Weight: 11.4 gm',
      'Rare',
    ],
  },

  { type: 'heading', text: 'SHAH JAHAN (1627-1658)' },
...

  {
    type: 'text',
    paragraphs: [
      `Shahjahan took control of Mughal empire after death of Jahangir. Throughout his reign the empire was prosperous and stable. This stability allowed him to take up many massive construction projects. One of the most important being the world famous 'Taj Mahal' built for his wife Mumtaz Begum. After her death, in memory he built this magnificent monument. The beauty and elegance of this monument is beyond description and millions visit every year to see it. Shahjahan built many other monuments during his reign, including Red Fort in Delhi. In his last days his son Aurangzeb took control of this dynasty (1658 AD). Shahjahan was imprisoned where he died 8 years later in 1666 AD.`,
      `Shown above are images of two his coins, both of which are in uncirculated condition and have the original shiny finish.`,
    ],
  },

  { type: 'heading', text: 'AURANGZEB (1658-1707)' },
...

  {
    type: 'text',
    paragraphs: [
      `Aurangzeb was truly the last Mughal. He inherited a great empire after a lot of bloodshed. His elder brother Dara Shikoh was an intellectual and a liberal. He was quite popular, but was a poor general. Dara and his two brothers lost the battles. Dara and Murad Baksh were captured and executed by Aurangzeb, while their father ShahJahan was imprisoned in nearby Agra fort from where he could see the TajMahal. Aurangzeb throughout his long 49 years of reign tried to keep the empire intact, often at the cost of a lot of bloodshed. Unfortunately, unlike the Akbar and his son Jahangir, he was a fanatic ruler. His rule witnessed re-introduction of religious tax, Jizia, which he imposed on the majority Hindu population and was callous witness to their persecution. This created a tremendous displeasure and religious tension among many of his generals, many of them were Rajput and Maratha warriors. He lacked sympathy, imagination, breadth of vision and elasticity of choice of means. In spite of vitality and ceaseless campaigns again his enemies, Aurangzeb proved to be a major failure as a ruler. In the intensity of his religious zeal, he ignored feelings of important sections of people (who did not profess Islam) and thus roused forces hostile to his empire.`,
  ...
  { type: 'heading', text: 'FARRUKHSIYAR (1713-1719)' },
  ...
  { type: 'heading', text: 'MUHAMMAD SHAH (1719-1748)' },
...

  {
    type: 'text',
    paragraphs: [
      `Now sayyid brothers 'the king makers', elevated youth of eighteen, a cousin of Farrukhsiyar, Roshan Akhtar to throne. He ascended the throne under the name of Muhammad Shah. He soon managed to find him powerful supporters including Nizam-ul-mulk of Deccan. In a very smart move, he killed both the Sayyid brothers and thus his long reign of 29 years started. He was young and fond of all kinds of pleasure (he is also known by another name, Rangeela, the careless fun-lover). His reign was full of utter confusion and he let the imperial affairs drift their own way with fatal consequences. Major provinces like Deccan, Awadh and Bengal slipped away, Marathas created their own massive kingdom and became very powerful. Thus within three decades after death of Aurangzeb, the vast Mughal empire spit into numerous independent or semi-independent states. Shown above is an extremely fine gold coin depicting his name, title, mint name and year (scarce to see all these on single coin).`,
    ],
  },

  { type: 'heading', text: 'Rise and fall of the Mughal Empire' },

  {
    type: 'text',
    paragraphs: [
      `Babar introduced a new system of collecting taxes and ruling the growing empire, called as Mansabdari, which essentially included providing a noble, known as Mansabdar, with a tract of land (Mansab in Arabic means rank). The size (both area as well as population) and its location would be used as determination of how much tax was expected to be collected. A part of which was to be sent to Emperor and part was expected to be used by the Mansabdar to maintain a well-trained cavalry. Since, the title was not hereditary (at least not in beginning), the nobles would exhibit high degree of loyalty as well as battle-preparedness. This was a brilliant move, as in no time Mughal emperors became fabulously wealthy (possibly the wealthiest in the world at that time) and could summon massive army at a short notice. Indeed, they would routinely use one noble against another to settle scores or extract more!`,
      `Although highly profitable, ensuring absolute opulent lifestyle for royal and noble households, this system broke the nation in multiple ways. First, emperors lost touch with populace (situation similar to 17-18th century France); regular income means they paid no attention towards the welfare of the populace. Mughal royalty and nobility were acutely aware of renaissance that took place in Europe due to their interaction with traders from many European nations. They even actively sought various items (including weapons), products of subsequent scientific awakening and achievements of European nations, however never put any effort to recreate the same. Unlike their contemporary European kings, Mughals did not build universities or educational institutions of higher learning where modern science and math would be taught. The early medieval knowledge in math, science and technology, accumulated in 4-9th century during Gupta and later dynasties period was not fostered and eventually lost. Soon the Mansabdari became hereditary, which made these nobles acquire more land on their own. Indeed, some of them had lands sizes of kingdom and now called themselves governors, with primary interest of collecting most taxes to maintain even larger armies. Overall outcome of this led to widespread illiteracy and poverty. The concept of logic, scientific questioning or systematic study of natural phenomenon was all but gone and it was the 'dark ages' of the Indian history.`,
      `The final nail was the implosion of the empire caused by the system itself; the nobles/governors now too powerful, rose against the weak emperor, and after Aurangzeb the empire was divided in dozens of large and small kingdoms. The later Mughal emperors were mere puppets often under influence of Marathas, with authority limited to the old city of Delhi.`,
    ],
  },
];
