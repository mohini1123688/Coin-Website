import './IndiasFirstCoinage.css';

const content = [
  { type: 'heading', text: 'ANCIENT INDIAN COINAGE' },
  ...
  { type: 'heading', text: 'Earliest Coins of India: The Punch-Marked Coins' },
  ...
  { type: 'heading', text: 'MAURYAS, THE FIRST EMPERORS' },
  ...
  {
    type: 'caption-block',
    title: 'Mauryan Empire (Ashoka the great)',
    lines: [
      '272-232 BC',
  ...
  },
  {
    ...
    lines: [
      '272-232 BC',
      'Silver Karshapana',
      'Obverse: Deity, Shiva (?) Standing, Sun and 4 other punchmarks',
      'Reverse: A single punchmark',
      'Weight: 3.35 gm (32 rattis)',
      'Reference: MAC 4178, GH#566',
      'Rare (rare to see deities on punchmarked coins)',
    ],
  },
  ...
  {
    type: 'caption-block',
    title: 'Amoghbhuti, Kuninda Dynasty',
    lines: [
      'Late 2nd Century BC',
...

  {
    type: 'text',
    paragraphs: [
      `Kuninda, which referred as Kulinda in ancient literature, issued very attractive silver coinage in late 2nd century BC. These coins were issued by king Amoghbhuti who ruled in the fertile valley of Yamuna (Jamuna), Beas and Sutlaj rivers (modern Punjab in northern India). The obverse of the coins shows a deer and Laxmi (goddess of wealth) is holding lotus in her uplifted hand. Between horns of deer, a cobra symbol is depicted. The reverse shows 6 symbols. Hill and river below, Nandipada (hoof of bull), tree in railing, Swastika and Y shaped symbol. Interestingly, the coins were bilingual. On obverse, legends were in Prakrit (closely related to Sanskrit), written in Brahmi script, while on reverse were in Kharoshti. The legends on obverse reads Rajnah Kunindasya Amoghabhutisya maharajasya. The reverse bears Maharajasa in Kharoshti script at the same place where Indo-Greek and Saka coins depicted their ruler's names.`,
      `These coins represent the first ever effort of an Indian ruler to issue silver coinage which could compete in market with that of Indo-Greek coinage. The Indo-Greek kings who ruled in neighboring areas (Bactria and Punjab) issued breathtaking examples of silver coins which, were highly sought after. This made Amoghbhuti to issue coins of purely Indian design but of exceptional beauty to ensure economic superiority over his neighbors. Shown above is this very attractive silver coin of ancient India.`,
