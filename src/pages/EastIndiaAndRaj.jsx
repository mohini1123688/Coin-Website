import './EastIndiaAndRaj.css';

const content = [
  { type: 'heading', text: 'EAST INDIA COMPANY COINAGE' },
  ...
  { type: 'heading', text: 'BRITISH RAJ COINAGE' },

  {
    type: 'text',
    paragraphs: [
      `Shown below are few portrait type coins of British india, popularly called Raj. The Raj coins were initially minted with mature portrait of Victoria, as queen, on obverse (an example shown below). Coins were minted in both silver (Rupees) and gold (Mohurs). Later, when she was declared as Empress of India, it was proclaimed by issuing coins in her name as Empress. Other British monarchs who succeeded her later appeared on the coins. The lower denomination in silver and copper (eg. half, quarter and 1/8th of rupee etc.) with identical style were also minted. In gold, the Double mohur coin initiated during William IV reign was discontinued and thus during Victorian era only one Mohur coin was issued. The silver coins were minted in millions in India which were to become the mainstay of economy of entire Indian subcontinent and were official currency in many neighbouring countries, including gulf countries.`,
    ],
  },
  ...
  {
    type: 'caption-block',
    title: 'Victoria, as Queen (mature bust)',
    lines: [
      'Silver Rupee',
      'Weight: 11.66 gms',
  ...
  { type: 'heading', text: 'COINS OF MODERN INDIA' },
