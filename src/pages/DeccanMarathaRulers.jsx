import './DeccanMarathaRulers.css';

const content = [
  { type: 'heading', text: 'Coins of Deccan & Maratha Rulers' },
  ...
  { type: 'heading', text: 'The Early Chalukyas (of Vatapi) or Eastern Chalukyas' },
  ...
  {
    type: 'caption-block',
    title: 'Eastern Chalukyas or their successors (Uncertain ruler)',
    lines: [
      '10th century AD (?)',
      'Gold, Pagoda',
  ...
  {
    type: 'caption-block',
    title: 'Chalukyas of Vatapi (Likely to be Vikramaditya II)',
    lines: [
      '733-744 AD',
  ...
  { type: 'heading', text: 'The Western Chalukyas (of Kalyani)' },
  ...
  {
    type: 'caption-block',
    title: 'Jayasimha II Jagadekamalla',
    lines: [
      '1015-1042 AD',
  ...
  { type: 'heading', text: 'Kalachuris of Kalyani' },
  ...
  { type: 'heading', text: 'Yadavas of Devgiri' },
  ...
  {
    type: 'caption-block',
    title: 'Singhan III (with queen Kamvaladevi)',
    lines: [
  ...
  { type: 'heading', text: 'Bhonsale of Pune' },
  ...
  {
    type: 'caption-block',
    title: 'Chatrapati Shivaji Bhonsale',
    lines: [
  ...
  {
    type: 'caption-block',
    title: 'Shivaji (the great)',
    lines: [
      '1674-1680 AD',
      'Hon, Weight: 2.36 gms, Silver',
      "Obverse: Legend in Devnagri 'Shri Raja Shiva'.",
      "Reverse: Legend in Devnagri 'Chatrapati'.",
      'Reference: MW T1; CNG Specimen, Triton XII, Lot 987 & Auction 73, Lot 1187',
      'Rare',
    ],
  },
  ...
  { type: 'heading', text: 'Shinde/Scindhia of Gwalior' },
  ...
  {
    type: 'caption-block',
    title: 'Baija Bai Shinde/Scindhia',
    lines: [
      'Maratha dynasty of Gwalior',
      '1827-1833 AD',
      'In name of Mughal emperor Mh. Shah',
      'Mohur, Weight: 10.80 gm, Gold',
      "Obverse: 'Shree' written in Devnagri, representing Shree Laxmi",
      'Minted at Lashkar in 1130 AH, Rgnal yr 2',
      'Reference: KM#126',
      'Uncirculated, Scarce',
    ],
  },
  ...
  {
    type: 'caption-block',
    title: 'Jankoji Rao Shinde/Scindhia',
    lines: [
      'Maratha dynasty of Gwalior',
      '1827-1843 AD or 1243-1259 AH',
      'In name of Mughal emperor Mh. Shah',
      'Mohur, Weight: 10.80 gm, Gold',
      "Obverse: 'Je' written in Devnagri, initial of ruler, Bow and arrow pointing downward",
      'Minted at Lashkar in 113(0) AH',
      'Reference: KM#132 (upward bow) and 133 (downward)',
  ...
  {
    type: 'caption-block',
    title: 'Jayaji Rao Shinde/Scindhia',
    lines: [
      'Maratha dynasty of Gwalior',
      '1843-1886 AD',
      'In name of Mughal emperor Mh. Shah',
  ...
  { type: 'heading', text: 'Holkars of Indore' },
  ...
  {
    type: 'caption-block',
    title: 'Yashwant (Jaswant) Rao Holkar',
    lines: [
      '1798-1811 AD',
      'Holkar of Indore',
      'Silver Rupee',
  ...
  {
    type: 'caption-block',
    title: 'Jaswant Rao Holkar',
    lines: [
      '1798-1811 AD',
      'Holkar of Indore',
      'Silver, Nazrana Rupee',
  ...
  { type: 'heading', text: 'Bhonsale of Nagpur' },
  ...
  { type: 'heading', text: 'Gaikwads of Baroda/Vadodara' },
  ...
  {
    type: 'caption-block',
    title: 'Pratap Singh Gaikwad',
    lines: [
      'Maratha dynasty of Baroda',
      '1938-1951 AD',
      'Mohur, Weight: 6.3 gm, Gold',
      "Obverse: Bust of Maharaja and legend in Devnagri 'Shrimant pratapsinh maharaj Gayakawad'",
      'Reverse: Sword, Denomination and year on minting, VS 1994',
      'Reference: Fr1041, KM41. Choice Extremely Fine, Rare',
    ],
  },

  { type: 'heading', text: 'Rise and Fall of Marathas' },

  {
    type: 'text',
    paragraphs: [
      `After defeat of Peshawa Baji Rao II in 1818 by British, the political supremacy of Marathas which was built on the ruins of Mughal empire, came to an end. Shivaji the great brought the Maratha empire into existence which was taken to its zenith by Peshwa Baji Rao I and remained undisputed military power till begining of 19th century. Maratha empire covered practically all of central and parts of Northern India. The Mughal emperor was under protection of Marathas and acted as puppet emperor with real power vested with Peshawas (or Shinde/Scindhias). This empire produced fine soldiers and statesman like Shivaji, Peshwa Baji Rao I, Peshwa Madhav Rao, Malhar Rao Holkar, Mahadaji Shinde and Nana Fadnavis. Unfortunately later Maratha chiefs had no foresight and they indulged more in intrigue and conspiracies against their own than realizing superior British diplomacy and military organization. British took full advantage of this internal confrontation and defeated most chiefs separately. Inability of all the Maratha chiefs to consolidate their military resources against British was the major cause of Maratha decline, which in turn resulted into passing power to a foreign nation. Soon after the collapse of Maratha empire, British took possession of a whole subcontinent in a quarter century as no formidable power left in India to challenge them.`,
...
export default function DeccanMarathaRulers() {
  return (
