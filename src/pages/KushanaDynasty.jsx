...
const content = [
  ...
  { type: 'heading', text: 'VIMA KADAPHISES (110-128 AD)' },
  ...
  {
    type: 'caption-block',
    title: 'Vima Kadphises — Gold Distater (or Double Dinar), Weight: 15.75 gms, Possibly the FIRST GOLD COIN of India',
    lines: [
  ...
  {
    type: 'caption-block',
    title: 'Vima Kadphises — Distater, Bilingual (Distater or Double Dinara/King on cloud, right), Weight 16.01 gms, Gold',
    lines: [
      "Obverse: Bust of king right on cloud, holding mace in right hand, far shoulder flaming, tamgha in left field. The Greek legend 'Basileus Ooema Kadaphises' starting at 'I' position.",
      'Reverse: Shiva standing facing, head left, holding trident in right hand, bull standing right behind him, nandipada in left field. The Kharoshti legends \'Maharajasa rajadirajasa sarvalogaishwarasa Mahiishwarasa Vima Kadaphisasa Tratara\' starting at XII position is around.',
      'Reference: Mint A, emission 3. Gobl 12 (same obverse die). For reverse die see Gobl 10,1',
      'Nearly mint state',
      'Extremely Rare',
    ],
  },
  ...
  {
    type: 'caption-block',
    title: 'Vima Kadphises — Distater, Bilingial (Distater or Double Dinara/King on cloud, Left), Weight: 15.93 gm, Gold',
    lines: [
      "Obverse: Bust of king left on cloud, holding raised mace in right hand and sword hilt in left, far shoulder flaming, tamgha in right field. The Greek legend 'Basileus Ooema Kadaphises' starting at 'I' position.",
      'Reverse: Shiva sanding facing, head left, holding trident in right hand, bull standing right behind him, nandipada in left field. The Kharoshti legends \'Maharajasa rajadirajasa sarvalogaishwarasa Mahiishwarasa Vima Kadaphisasa Tratara\' starting at XII position is around. Nandipada symbol is on left.',
      'Reference: Mint A, emission 3. Gobl 13.',
      'Good extremely fine',
      'Extremely Rare',
    ],
  },
  ...
  },
  {
    ...
    title: 'Vima Kadphises',
    lines: [
      'Quarter Stater, Bilingual (King looking through window)',
      'Weight: 1.95 gm, Gold',
...

  {
    ...
    paragraphs: [
      ...
      `This switching of deity on Kushan coinage is very interesting facet of the transition period of Kushan history. Gupta emperor, Samudragupta was the first to take serious note of coinage of his predecessors. No doubt, Samudragupta carefully studied the available Kushan coinage. He minted first gold coins of Gupta dynasty which were almost copied from later Kushan.`,
      `The silk road trade played a crucial role in Kushan coinage. The Kushan empire was located strategically between China and Roman empire and thus controlled the trade of silk, spices, teas and precious metals & gems. The Kushan rulers promoted and protected the trade routes and in turn profited significantly. The trade with Rome had brought large quantity of Roman gold coins in Kushan empire, which were melted for the coin production in Kushan mints. Northern India never had much of gold producing mines, thus indicating the Roman gold which poured in India in ample due to the trade, was the major source of Kushan gold. The Kushan gold weight standard of ~8 gm is very close to Greek and early Roman gold coinage. Silver coins were rarely minted, which could be because of the widespread availability and/or debasement in earlier punchmarked coins.`,
    ],
  },
  ...
  { type: 'heading', text: 'HUVISHKA (154-192 AD)' },
  ...
  },
  {
    ...
    lines: [
      '154-192 AD',
      'Stater/Dinar (Elephant Rider), Weight: 7.83 gm, Gold',
      'Obverse: Huvishka riding elephant right The Bactrian legend \'Shaonano Shao Ooeshki Koshano\' the King of Kings, Huvishka',
      'Reverse: "Ardoksho", nimbate goddess standing right, holding cornucopiae, tamgha in right field',
      'Reference: Gobl#305A',
      'Very Fine',
      'Extremely Rare (only one in Gobl)',
    ],
  ...
  },
  {
    ...
    lines: [
      ...
      'Reference: Not in Gobl, Unpublished',
      'Very Fine',
      'Extremely Rare',
    ],
  },
  ...
  },
  {
    ...
    title: 'Huvishka',
    lines: [
      'Stater/Dinar, Weight: 7.83 gm, Gold',
      'Obverse: Half length profile Bust of King to left, emerging from clouds, wearing rounded helmet decorated with antlers and crest ornament, jeweled yoke and loose fitting tunic. Ornamental mace in his left hand and Ankusha (elephant goad or royal sceptre) in right. King is sporting Galamucha (sideburn). The Bactrian legend Shaonano Shao Ooeshki Koshano starting at VII position.',
      'Reverse: The nimbate figure of Mahasena (MAACHNO, MAASENO in Bactrian) is standing, facing. He is holding an eagle-topped ribboned staff in his right hand and his left hand is resting on his hip. He has sword suspended from the waist.',
      'Reference: Gobl#298.2',
      'Extremely Rare',
    ],
  },
  ...
  },
  {
    ...
    lines: [
      ...
      'Reference: Gobl#156.1 (same dies)',
      'Almost Extremely Fine, choice specimen',
      'Extremely Rare',
    ],
  },
  ...
  { type: 'heading', text: 'VASUDEVA I (192-228 AD)' },
  ...
  },
  {
    ...
    lines: [
      ...
      'Extremely Fine, choice specimen',
      'Extremely Rare',
    ],
  },
  ...
  },
  {
    ...
    lines: [
      '192-228 AD',
      'Stater/Dinar, Weight: 8 gm, Gold',
      'Obverse: King Sacrificing at Altar with right hand, the left hand holding the trident.',
      'Reverse: Four-Armed, Three-headed Shiva, side heads are NOT human, human and Bull type, standing with Nandi',
      'Reference: Unpublished, NOT in Gobl, Similar to Gobl#500',
  ...
  {
    type: 'caption-block',
    title: 'Vasudeva I (Possibly Vasudeva II)',
    lines: [
      ...
      'Reference: Gobl#525 (O1/R1); Donum Burns 433. Mint I (A). 1st emission.',
      'Very Fine, choice specimen',
      'Extremely Rare',
    ],
  },
  ...
  { type: 'heading', text: 'KANISHKA II (228-250 AD)' },
  ...
  { type: 'heading', text: 'VASHISHKA (250-268 AD)' },
  ...
  },
  {
    ...
    title: 'Vashishka',
    lines: [
      'Kushan Dynasty, 250-268 AD',
      'Stater, Weight: 7.85 gm, Gold',
      ...
      'Reference: MK 630; MACW 3505 corr. ("Ku?" present, but not mentioned).',
      'Nearly Extremely Fine, choice specimen',
      'Rare',
    ],
  },

  { type: 'heading', text: 'MAGRA (4th Century AD)' },
  ...
  },
  {
    ...
    title: 'Magra',
    lines: [
      'Later Kushan/Rebel, 4th century AD, Contemporary of Samudragupta?',
      'Stater, Weight: 7.76 gm, Gold',
      'Obverse: King standing, wearing late Kushan style loose-fitting garment, heavy boots on his feet. He is seen sacrificing at Altar with his right hand, but in his left arm, he holds instead of the long-handled trident, staff topped with a Chakra or Wheel. The legend is corrupted bactrian, copied from late Kushan gold staters. The legend Magra in Brahmi is on right of the staff.',
      'Reverse: Ardoxsho, very similar to later Kushan',
      'Reference: Gobl#578; MK 578 ("Usurper I"); Donum Burns 744.',
      'Almost Extremely Fine',
      'Very Rare (Five specimen are in Gobl)',
    ],
  },

  {
    type: 'text',
    paragraphs: [
      `Magra is considered as a ruler of 'Later Kushan Dynasty', indeed, he could have been the Rebel ruler as Kushan reign was pretty much over. This gold stater is of considerable significance; possibly minted in 4th century AD, Magra could have been a contemporary of Samudragupta. The obverse shows King standing, wearing late Kushan style loose-fitting garment, heavy boots on his feet. He is seen sacrificing at Altar with his right hand, but in his left arm, he holds instead of the long-handled trident, staff topped with a Chakra or Wheel. The legend is totally corrupted Bactrian, copied from late Kushan gold staters. The legible legend instead is in Brahmi, reads the name of King, Magra on right of the staff. On the Reverse is Ardoxsho, very similar to later Kushan. It is believed that this coin was used as a prototype by Samudragupta to mint his Kacha series of gold coins, wherein he is shown carrying a 'Chakra' or wheel. Considering the fact that Samudragupta's coinage was heavily influenced by Kushan, it not very surprising. Historically this is very interesting and rare coin.`,
    ],
  },
];
