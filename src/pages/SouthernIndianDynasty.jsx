import './SouthernIndianDynasty.css';

const content = [
  { type: 'heading', text: 'COINS OF SOUTHERN INDIAN DYNASTY' },

  { type: 'heading', text: 'The Cholas of Tanjavur' },
  ...
  {
    type: 'caption-block',
    title: 'Anonymous coin of Sri lanka',
    lines: [
  ...
  { type: 'heading', text: 'Hoysalas of Dwarasamudra' },
  ...
  },
  {
    ...
    lines: [
      ...
      'Extremely Fine, Beautiful specimen, Extremely Rare',
    ],
  },
  ...
  },
  {
    ...
    lines: [
      ...
      'Gadyana, Single Die struck, Weight: 4.1 gm, Gold',
  ...
  { type: 'heading', text: 'Gangas of Talakad (Western Gangas)' },
  ...
  },
  {
    ...
    lines: [
      '1080-1138 AD',
      'Gold Pagoda, Gajapati Pagoda (left); double fanam (right)',
      'Obverse: Caparisoned elephant looking right',
      'Reverse: Ornamental scrollwork, derived from Chalukya coins',
      'Weight: 3.88 gms (left), 0.69 (right)',
      'Ref: MNI 702',
      'Double Fanam (right) is Rare',
    ],
  },
  ...
  { type: 'heading', text: 'Kadambas of Hangal' },
  ...
  {
    type: 'caption-block',
    title: 'Unknown ruler, Kadamba Dynasty',
    lines: [
      '12th Century AD',
  ...
  { type: 'heading', text: 'The Kadambas of Goa' },
  ...
  {
    type: 'caption-block',
    title: 'Shivachitta Paramadideva',
    lines: [
      '1147-1187 AD',
      'Gold stater/Pagoda',
  ...
  { type: 'heading', text: 'The Vijayanagar Empire' },
...

  {
    type: 'text',
    paragraphs: [
      `He lost control to his brother-in-law Tirumala. Eventually, the power was trasferred to prime minister Ram Raya who seized the throne for himself. Finally, three muslim sultanates of Deccan, Bijapur, Ahmadnagar and Golkonda formed a coalition and met the massive Vijaynagar Army (half a million!) near village Tagdi on 23rd January 1565 AD. In spite of the vast numerical superiority over allied forces, Vijayanagar lost the war. A small group of soldiers separated the elephant of Ram Raya from his army in a swift move. He was at once beheaded by Husain Nizam Shah. The whole army in confusion left the battle ground and 250 years old empire was lost in few hours . What followed was one of the greatest plunder and destruction in the history of India. According to historian, Sewell 'After victory, muslims reached capital and for next five month they destroyed and plundered relentlessly. Nothing seemed to escape them. They burned magnificent buildings, pavillions and finally the beautiful Vithalswami temple near the river. With swords, crowbars and axes they smashed exquisite stone sculptures. Never perhaps in history of the world such havoc has been wrought on so splendid city, teeming with a wealthy and industrious population. City was seized, pillages and reduced to ruins, amid scenes of savage massacre and horrors beggaring description'.`,
      `The ruins of Vijayanagar city can be seen today near Hampi in modern Karnataka state, which realistically reflects the splendor and opulence during the reigns of Rayas of Vijayanagar. This so called battle of Talikota was one of the decisive battles in the history of India. In spite of the tremendous damage, Vijayanagar did survive but the old grandeur was lost. Coalition forces did not gain much in spite of all out victory. Alliance was soon dissolved and brother of Rama Raya took this opportunity and tried to bring back the old glory to the kingdom. After death of Venkata II in 1614, the kingdom disintegrated and went into total obscurity.`,
    ],
  },
];

export default function SouthernIndianDynasty() {
  return (
