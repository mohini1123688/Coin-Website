import './WesternCentralIndianDynasty.css';

const content = [
  { type: 'heading', text: 'COINS OF WESTERN AND CENTRAL INDIAN DYNASTY' },

  { type: 'heading', text: 'Coins of Satavahanas' },
  ...
  {
    type: 'caption-block',
    title: 'Vashistiputra Shree Pulumavi',
    lines: [
      'Satavahana Dynasty',
      '78-114 AD or 110-138 AD',
  ...
  {
    type: 'caption-block',
    title: 'Vashistiputra Shree Satakarni',
    lines: [
      '118-147 AD',
  ...
  {
    type: 'caption-block',
    title: 'Gautamiputra Shree Yagna Satakarni',
    lines: [
      '167-196 AD',
      'Silver Drachm or Dramma, Weight: 2 gms, Silver',
  ...
  { type: 'heading', text: 'Coins of Kshatrapas' },
  ...
  {
    type: 'caption-block',
    title: 'Rudrasen II as Mahakshatrapa',
    lines: [
      '256-278 AD',
      'Silver Dramma',
      'Obverse: Bust of King',
      'Reverse: Hill and river, Weight: 2.2 gm',
  ...
  },
  {
    ...
    lines: [
      ...
      'Silver Dramma',
      'Obverse: Bust of King',
      'Reverse: Hill and river, Weight: 2.3 gm',
  ...
  { type: 'heading', text: 'The Maitrakas of Valabhi' },
  ...
  {
    type: 'caption-block',
    title: 'Bhattaraka (title: Senapati)',
    lines: [
      '470-800 AD',
      'Silver Dramma',
      'Obverse: Bust of King',
  ...
  { type: 'heading', text: 'COINS OF POST-GUPTA DYNASTIES' },
  ...
  { type: 'heading', text: 'The Vardhanas of Kannauj and Thanesar' },
  ...
  {
    type: 'caption-block',
    title: 'Harshavardhana (Siladitya)',
    lines: [
      '606-647 AD',
  ...
  { type: 'heading', text: 'The Imperial Pratiharas' },
  ...
  { type: 'heading', text: 'The Hindu Shahi of Kabul' },
  ...
  { type: 'heading', text: 'COINS OF North-Central DYNASTIES' },
  ...
  { type: 'heading', text: 'The Kalachuris of Tripuri or Dahal' },
  ...
  { type: 'heading', text: 'The Kacchapaghata (Kacchwahas) of Narwar' },
  ...
  { type: 'heading', text: 'Gahadvala of Banaras and Kannauj' },
  ...
  { type: 'heading', text: 'The Chahamanas of Sambhor, Ajmer and Delhi' },
  ...
  {
    type: 'caption-block',
    title: 'Vigraharaja IV',
    lines: [
      '1153-1163 AD',
      'Chahamans of Sambhor and Ajmer, Gold Stater',
