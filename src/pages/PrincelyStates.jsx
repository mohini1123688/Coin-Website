...
const content = [
  ...
  { type: 'heading', text: 'Awadh or Oudh' },
...

  {
    type: 'text',
    paragraphs: [
      `More than 500 such princely states were present in India prior to 1947. Coins of some of the states are enclosed. This area is too large to cover in this small section.`,
    ],
  },
];

export default function PrincelyStates() {
  return (
