...
const content = [
  ...
  {
    type: 'caption-block',
    title: 'Kumardevi and Chandragupta I',
    lines: [
  ...
  { type: 'heading', text: 'SAMUDRAGUPTA (335-380 AD)' },
  ...
  },
  {
    ...
    lines: [
      '335-370 AD',
      'Gold Dinar (Standard type or Royal Sceptre type)',
      'Weight: 7.7 gm',
      'Obverse: King sacrificing at altar',
      'Reverse: Laxmi sitting holding diadem in right hand and cornucopia in left hand',
      'Reference: MAC#4773 ff',
    ],
  },
  ...
  {
    type: 'caption-block',
    title: 'Vikramaditya or Chandragupta II',
    lines: [
      '375-414 AD',
  ...
  },
  {
    ...
    lines: [
      ...
      'Reference: BMC Plate 114, pl IX3 obverse; Altekar Bayana Plate',
      'Finest animated style, broad flan',
      'Very Rare in such condition',
    ],
  },

  { type: 'heading', text: 'KUMARGUPTA I or MAHENDRADITYA (415-455 AD)' },
  ...
  { type: 'heading', text: 'SKANDAGUPTA (455-467 AD)' },
